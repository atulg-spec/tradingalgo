...
SECRET_KEY = 'django-insecure-&#8*ez=&+6^e_i_=xs70m@e461!)==ey$q#wb8ee4w4chtf68!'
...
STATIC_ROOT = '/home/smartalgo/public_html/static'
STATICFILES_DIRS = [
    # Add additional directories if necessary
